...
export const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_KRNL_CONTRACT_ADDRESS;

// KRNL API credentials
export const ENTRY_ID = process.env.NEXT_PUBLIC_KRNL_ENTRY_ID;
export const ACCESS_TOKEN = process.env.NEXT_PUBLIC_KRNL_ACCESS_TOKEN;

// Contract ABI for the game contract
export const abi = [
  {
    "inputs": [
      {
